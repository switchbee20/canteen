   ...
   <div class="user-info">
      ...
      <select name="method" class="box" required>
         ...
         <option value="Scan and Pay">Scan and Pay</option>
            <option value="Pay during Pickup">Pay during Pickup</option>
      </select>

        <div class="box1">
          <label for="Scan&pay"><h4>For Scan and Pay use the following QR Code</h4></label>
        </div>
        <div >
        <img src="images/qrexample.png" height="200" width="200" >
